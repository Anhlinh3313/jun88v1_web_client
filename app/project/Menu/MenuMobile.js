...
const menuBottom = [
  ...
  },
  {
    element: (
      <Link href={"/ket-qua-bong-da"}>
        <a>
          <div className={Styles.menu_bottom_item}>Kết quả</div>
        </a>
      </Link>
    ),
    event: () => {},
  ...
  {
    element: (
      <Link href={"/ty-so-truc-tuyen"}>
        <a>
          <div className={Styles.menu_bottom_item}>Tỷ số </div>
        </a>
      </Link>
    ),
    event: () => {},
    status: true,
    path: "ty-so-truc-tuyen",
  },
  {
    element: (
      <Link href={"/bong-da"}>
  ...
  },
  {
    element: (
      <Link href={"/tips"}>
        <a>
          <div className={Styles.menu_bottom_item}>Tips</div>
        </a>
      </Link>
    ),
    event: () => {},
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Image style={{width: 150, height: 100}} className={Styles.img} src={ImgLogo} alt="" />

          <div className="absolute right-3">
            {user ? 
              <Avatar src={AvatarImg} onClick={() => router.push(`/account-m/${user._id}`) } className="display-center cursor-pointer" icon={<AiOutlineUser />} /> : 
              <Link href={"/login"} className={Styles.header_menu_login}>Đăng nhập</Link>
            }
          </div>
